...
export function InputGroup({
    ...
    return (
        // biome-ignore lint/a11y/useSemanticElements: This groups one input with visual addons, not multiple fieldset controls.
        <div
            className={cn(
...
export function InputGroupAddon({
    ...
    return (
        // biome-ignore lint/a11y/noStaticElementInteractions: Clicking a non-interactive addon intentionally focuses its associated input.
        <div
