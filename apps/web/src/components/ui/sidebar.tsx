...
export function SidebarProvider({
    ...
    // Use a stable state name for data-attribute styling.
        ...
        <SidebarContext.Provider value={contextValue}>
            <div
                className={cn(
                    ...
                    // Keep the sidebar gap and centered content on the same animation.
                    "[--sidebar-gap:0px] transition-[--sidebar-gap] duration-150 ease-out md:data-[state=expanded]:[--sidebar-gap:var(--sidebar-width)]",
                    className
                )}
...
export function Sidebar({
    ...
    return (
        ...
        >
            <div
                className={cn(
                    // Follow the shared gap instead of animating width separately.
                    "relative w-(--sidebar-gap) bg-transparent",
...
export function SidebarTrigger({
    ...
    // Mobile uses its sheet state; desktop uses the shared sidebar state.
...
export function SidebarGroupLabel({
    ...
    const defaultProps = {
        className: cn(
            "flex h-8 shrink-0 items-center rounded-lg px-2 font-medium text-sidebar-foreground text-xs outline-hidden ring-sidebar-ring transition-[margin,opacity] duration-150 ease-out focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
export function SidebarMenuSkeleton({
    ...
    // Vary skeleton rows so the placeholder feels natural.
